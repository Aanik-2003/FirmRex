...
class EditWellnessRecords {
                          ...
                          onPressed: () async {
                            ...
                            if (vaccineName.isNotEmpty && selectedDate != null && doctorName.isNotEmpty) {
                              ...
                              try {
                                ...
                                bool success = await _medicalController.addNewVaccines(vaccineName, selectedDate!, doctorName);
  ...
  void showVaccineDetailsPopup(BuildContext context, Map<String, dynamic> newVaccines) {
    showDialog(
      context: context,
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              // Vaccine Name
              Text(
                "Vaccine Name: ${newVaccines['vaccineName'] ?? 'Unknown Vaccine'}",
              ...
              // Date Given
              Text(
                '${newVaccines['dateGiven'].day}/${newVaccines['dateGiven'].month}/${newVaccines['dateGiven'].year}',
                style: const TextStyle(
                  fontSize: 14,
              ...
              // Doctor Name
              Text(
                "Doctor: ${newVaccines['doctorName'] ?? 'Unknown'}",
                style: const TextStyle(
                  fontSize: 14,
                  color: Colors.black54,
                ),
              ...
              const SizedBox(height: 10),
              // Image Display
              if (newVaccines['image_base64'] != null)
                GestureDetector(
                  onTap: () {
                    // Show full-size image when clicked
                    showFullSizeImage(context, newVaccines['image_base64']);
                  },
                  child: Image.memory(
                    base64Decode(newVaccines['image_base64']),
                    height: 100,
                    width: 100,
                    fit: BoxFit.cover,
                  ),
